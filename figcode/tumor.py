...
FIG_NAME = "sft"
H5AD_PATH = PROJECT_DIR / "h5ad" / "sft.h5ad"
...
marker_genes_dict = {
    "Reactive SFT": [
        "IRF1", "GBP1", "NFKBIZ", "PTGS2", "ICAM1", "ATF3", "CD82"
    ],

    "COL17A1+ SFT": [
        "COL17A1", "COMP", "SAA1", "ABLIM1", "LMO4", "IGFBP6", "IGF1"
    ],

    "MEST+ SFT": [
        "CNTN6", "MEST", "SLC26A7", "BCAS1", "S100A10", "CDK6", "GRIA2", "FZD7"
    ],

    "NGFR+ SFT": [
        "NGFR", "FOXC2", "BCAN", "CCDC80", "ZIC2", "NDRG2", "LGALS3"
    ],

    "Cycling SFT": [
        "TOP2A", "MKI67", "NUSAP1", "BIRC5", "UBE2C", "PBK", "RRM2", "CCNB2"
    ],

    "ECM-remodeling SFT": [
        "IGFBP7", "SCRG1", "CCDC3", "RBP4", "IGFBP3", "PRELP", "TAGLN", "CCN2", "LOX", "MMP2"
    ],
}
